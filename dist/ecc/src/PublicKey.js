...
var PublicKey = function () {
    ...
    PublicKey.prototype.toString = function toString() {
        var address_prefix = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _seerjsWs.ChainConfig.address_prefix;
    ...
    */
    ...
    PublicKey.fromPublicKeyString = function fromPublicKeyString(public_key) {
        var address_prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _seerjsWs.ChainConfig.address_prefix;
