...
export const witness_create_collateral_operation_fee_parameters = new Serializer(
    "witness_create_collateral_operation_fee_parameters",
    { fee: int64 }
);

export const witness_cancel_collateral_operation_fee_parameters = new Serializer(
    "witness_cancel_collateral_operation_fee_parameters",
    { fee: int64 }
);

export const witness_claim_collateral_operation_fee_parameters = new Serializer(
    "witness_claim_collateral_operation_fee_parameters",
    { fee: int64 }
);
...
export const seer_oracle_create_fee_parameters = new Serializer(
    "seer_oracle_create_fee_parameters",
    {
        fee: uint64,
        price_per_kbyte: uint32
    }
...
export const seer_oracle_update_fee_parameters = new Serializer(
    "seer_oracle_update_fee_parameters",
    {
        fee: uint64,
        price_per_kbyte: uint32
    }
...
export const seer_oracle_input_fee_parameters = new Serializer(
    "seer_oracle_input_fee_parameters",
    {fee: uint64}
);

export const seer_room_create_fee_parameters = new Serializer(
    "seer_room_create_fee_parameters",
    {
        fee: uint64,
        price_per_kbyte: uint32
    }
...
export const seer_room_update_fee_parameters = new Serializer(
    "seer_room_update_fee_parameters",
    {
        fee: uint64,
        price_per_kbyte: uint32
    }
...
export const seer_room_input_fee_parameters = new Serializer(
    "seer_room_input_fee_parameters",
    {
        fee: uint64
    }
);

export const seer_room_open_fee_parameters = new Serializer(
    "seer_room_open_fee_parameters",
    {
        fee: uint64
    }
);

export const seer_room_stop_participating_fee_parameters = new Serializer(
    "seer_room_stop_participating_fee_parameters",
    {
        fee: uint64
    }
);

export const seer_room_final_fee_parameters = new Serializer(
    "seer_room_final_fee_parameters",
    {
        fee: uint64
    }
);

export const seer_room_settle_fee_parameters = new Serializer(
    "seer_room_settle_fee_parameters",
    {
        fee: uint64
    }
);
...
export const seer_room_participate_fee_parameters = new Serializer(
    "seer_room_participate_fee_parameters",
    {
        fee: uint64
    }
);

export const seer_room_close_fee_parameters = new Serializer(
    "seer_room_close_fee_parameters",
    {
        fee: uint64
    }
);

export const seer_room_claim_fee_parameters = new Serializer(
    "seer_room_claim_fee_parameters",
    {
        fee: uint64
    }
);

export const seer_house_create_fee_parameters = new Serializer(
    "seer_house_create_fee_parameters",
    {
        fee: uint64,
        price_per_kbyte: uint32
    }
...
export const seer_house_update_fee_parameters = new Serializer(
    "seer_house_update_fee_parameters",
    {
        fee: uint64,
        price_per_kbyte: uint32
    }
...
export const account_authentication_apply_fee_parameters = new Serializer(
    "account_authentication_apply_fee_parameters",
    { fee: uint64 }
);

export const seer_supervisor_create_operation_fee_parameters = new Serializer(
    "seer_supervisor_create_operation_fee_parameters",
    { fee: uint64,
    price_per_kbyte: uint32 }
);

export const seer_supervisor_update_operation_fee_parameters = new Serializer(
    "seer_supervisor_update_operation_fee_parameters",
    { fee: uint64,
    price_per_kbyte: uint32 }
);

export const seer_supervisor_process_operation_fee_parameters = new Serializer(
    "seer_supervisor_process_operation_fee_parameters",
    { fee: uint64 }
);

export const seer_authenticator_create_operation_fee_parameters = new Serializer(
    "seer_authenticator_create_operation_fee_parameters",
    { fee: uint64,
    price_per_kbyte: uint32 }
);

export const seer_authenticator_update_operation_fee_parameters = new Serializer(
    "seer_authenticator_update_operation_fee_parameters",
    { fee: uint64,
    price_per_kbyte: uint32 }
);

export const seer_authenticator_process_operation_fee_parameters = new Serializer(
    "seer_authenticator_process_operation_fee_parameters",
    { fee: uint64 }
);

export const asset_create_market_operation_fee_parameters = new Serializer(
    "asset_create_market_operation_fee_parameters",
    { first_base: uint64,second_base:uint64 }
);
...
export const witness_create_collateral = new Serializer(
    "witness_create_collateral",
    { fee: asset,
    witness: protocol_id_type("witness"),
    witness_account: protocol_id_type("account"),
    amount: int64 }
...
export const witness_cancel_collateral = new Serializer(
    "witness_cancel_collateral",
    { fee: asset,
    witness: protocol_id_type("witness"),
    witness_account: protocol_id_type("account"),
...
export const witness_claim_collateral = new Serializer(
    "witness_claim_collateral",
    { fee: asset,
    witness: protocol_id_type("witness"),
    witness_account: protocol_id_type("account"),
...
export const oracle_create = new Serializer(
    "oracle_create",
    { fee: asset,
    issuer: protocol_id_type("account"),
    guaranty: int64,
...
export const oracle_update = new Serializer(
    "oracle_update", { fee: asset,
    issuer: protocol_id_type("account"),
...
export const oracle_input = new Serializer(
    "oracle_input", {fee: asset,
    issuer: protocol_id_type("account"),
    oracle: protocol_id_type("oracle"),
...
export const seer_oracle_filter = new Serializer(
    "seer_oracle_filter",
    { reputation: uint64,
    guaranty: uint64,
    volume: uint64 }
...
export const room_option = new Serializer(
    "room_option",
    { result_owner_percent: uint32,
...
export const lmsr_special_option = new Serializer(
    "lmsr_special_option",
    {
    L: int64 }
);

export const advanced_special_option = new Serializer(
    "advanced_special_option",
    {
    pool: int64,
    awards: array(uint64)
});

export const seer_room_initial_option = new Serializer(
    "seer_room_initial_option",
    {
    room_type: uint8,
...
export const single_participate = new Serializer(
    "single_participate",
...
export const multi_participate = new Serializer(
    "multi_participate",
    { player: protocol_id_type("account"),
    amount: int64,
...
export const multi_participate2 = new Serializer(
    "multi_participate2",
    { player: protocol_id_type("account"),
    amount: int64,
...
export const index = new Serializer(
    "index",
    { v1: uint32,
    v2: uint32 }
);

export const index3 = new Serializer(
    "index3",
    { v1: int64,
    v2: int64,
    v3: int64}
...
export const result_of_win = new Serializer(
    "result_of_win",
    { total_amount: int64,
...
export const seer_room_option_type3_history = new Serializer(
    "seer_room_option_type3_history",
    { description: string,
...
export const seer_room_option_type3 = new Serializer(
    "seer_room_option_type3",
    { selection_description: array(string),
...
export const seer_room_create = new Serializer(
    "seer_room_create",
    { fee: asset,
    issuer: protocol_id_type("account"),
    label: set(string),
...
export const seer_room_update = new Serializer(
    "seer_room_update",
    { fee: asset,
    issuer: protocol_id_type("account"),
    room: protocol_id_type("room"),
...
export const seer_room_participate = new Serializer(
    "seer_room_participate",
    { fee: asset,
    issuer: protocol_id_type("account"),
    room: protocol_id_type("room"),
    type: uint8,
...
export const seer_room_open = new Serializer(
    "seer_room_open",
    { fee: asset,
    issuer: protocol_id_type("account"),
    room: protocol_id_type("room"),
...
export const seer_room_stop_participating = new Serializer(
    "seer_room_stop_participating",
    { fee: asset,
    issuer: protocol_id_type("account"),
    room: protocol_id_type("room"),
    input_duration_secs: uint32 }
...
export const seer_room_close = new Serializer(
    "seer_room_close",
    { fee: asset,
    issuer: protocol_id_type("account"),
    room: protocol_id_type("room"),
...
export const seer_room_final = new Serializer(
    "seer_room_final",
    { fee: asset,
    issuer: protocol_id_type("account"),
    room: protocol_id_type("room") }
...
export const seer_room_settle = new Serializer(
    "seer_room_settle",
    { fee: asset,
    issuer: protocol_id_type("account"),
    room: protocol_id_type("room") }
...
export const seer_room_input = new Serializer(
    "seer_room_input",
    { fee: asset,
    issuer: protocol_id_type("account"),
    room: protocol_id_type("room"),
...
export const seer_room_claim = new Serializer(
    "seer_room_claim",
    { fee: asset,
    issuer: protocol_id_type("account"),
    room: protocol_id_type("room"),
...
export const seer_house_create = new Serializer(
    "seer_house_create",
    { fee: asset,
    issuer: protocol_id_type("account"),
    guaranty: int64,
...
export const seer_house_update = new Serializer(
    "seer_house_update",
    { fee: asset,
    issuer: protocol_id_type("account"),
...
export const account_authentication_apply = new Serializer(
...
export const seer_supervisor_create = new Serializer(
    "seer_supervisor_create",
    { fee: asset,
    issuer: protocol_id_type("account"),
    country: uint16,
    description: string,
...
export const seer_supervisor_update = new Serializer(
    "seer_supervisor_update",
    { fee: asset,
    issuer: protocol_id_type("account"),
...
export const seer_supervisor_process = new Serializer(
    "seer_supervisor_process",
    { fee: asset,
    issuer: protocol_id_type("account"),
    supervisor: protocol_id_type("supervisor"),
...
export const seer_authenticator_create = new Serializer(
    "seer_authenticator_create",
    { fee: asset,
    issuer: protocol_id_type("account"),
    description: string,
    script: string}
...
export const seer_authenticator_update = new Serializer(
    "seer_authenticator_update",
    { fee: asset,
    issuer: protocol_id_type("account"),
    authenticator: protocol_id_type("authenticator"),
    description: optional(string),
...
export const seer_authenticator_process = new Serializer(
    "seer_authenticator_process",
    { fee: asset,
    issuer: protocol_id_type("account"),
    authenticator: protocol_id_type("authenticator"),
